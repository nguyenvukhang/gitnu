...
pub const GIT_CMD: [&str; 164] = [
    ...
    "bisect", "blame", "branch", "bugreport", "bundle", "cat-file",
    "check-attr", "check-ignore", "check-mailmap", "check-ref-format",
    "checkout", "checkout-index", "cherry", "cherry-pick", "citool", "clean",
    "cli", "clone", "column", "commit", "commit-graph", "commit-tree", "config",
    "count-objects", "credential", "credential-cache", "credential-store",
    ...
    "fmt-merge-msg", "for-each-ref", "for-each-repo", "format-bundle",
    "format-chunk", "format-commit-graph", "format-index", "format-pack",
    "format-patch", "format-signature", "fsck", "gc", "get-tar-commit-id",
    "gitk", "gitweb", "grep", "gui", "hash-object", "help", "hook", "hooks",
    "http-backend", "ignore", "imap-send", "index-pack", "init", "instaweb",
    "interpret-trailers", "log", "ls-files", "ls-remote", "ls-tree", "mailinfo",
    "mailmap", "mailsplit", "maintenance", "merge", "merge-base", "merge-file",
    "merge-index", "merge-one-file", "merge-tree", "mergetool", "mktag",
    "mktree", "modules", "multi-pack-index", "mv", "name-rev", "notes", "p4",
    "pack-objects", "pack-redundant", "pack-refs", "patch-id",
    "protocol-capabilities", "protocol-common", "protocol-http",
    "protocol-pack", "protocol-v2", "prune", "prune-packed", "pull", "push",
    "quiltimport", "range-diff", "read-tree", "rebase", "reflog", "remote",
    "repack", "replace", "repository-layout", "request-pull", "rerere", "reset",
    ...
    "status", "stripspace", "submodule", "svn", "switch", "symbolic-ref", "tag",
    "unpack-file", "unpack-objects", "update-index", "update-ref",
    "update-server-info", "var", "verify-commit", "verify-pack", "verify-tag",
